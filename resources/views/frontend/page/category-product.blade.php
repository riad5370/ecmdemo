              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active dropdown" aria-current="page">
                    Product by Category:
                    <a href="#" class="dropdown-toggle" id="categoryDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <strong>{{ $category_name->name }}</strong>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                      <!-- Add your dropdown items here -->
                      @foreach ($subcategoryProducts as $subcategory)
                       <a class="dropdown-item" href="{{ route('subcategory.product', $subcategory->id) }}">{{$subcategory->name}}</a>
                      @endforeach
                    </div>
                  </li>
                </ol>
