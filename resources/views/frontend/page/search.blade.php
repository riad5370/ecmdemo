                                            ...
                                            <div class="inner_widget_link">
                                                <ul class="no-ul-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <label for="brands1" class="checkbox-custom-label">{{$all_brand->name}}<span>142</span></label>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                            ...
                            <div class="product_grid card b-0">
                                ...
                                <div class="card-body p-0">
                                    <div class="shop_thumb position-relative">
                                        <a class="card-img-top d-block overflow-hidden" href="{{ route('details',$product->slug) }}"><img class="card-img-top" src="{{ asset('images/products/preview/'.$product->preview) }}" alt="..."></a>
                                    </div>
                                </div>
