...
@php
   $signUpcustomer = $customers->count();  
@endphp
<div class="col-xs-12">
    <div class="clearfix">
    ...
    <div class="table-header">
        All SignUp Customers ({{$signUpcustomer}})
    </div>
    <div class="">
            ...
            <tbody>
                @foreach($customers as $sl=>$customer)
                    <tr>
                        ...
                        <td class="center">
                            <a href="{{ route('delete.customers', $customer->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this customer?');">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
