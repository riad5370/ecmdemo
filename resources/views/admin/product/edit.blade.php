...
<div style="background-color: #3498DB; width:100%;height:190px;">
    <h2 style="margin: 0; color: white; text-shadow: 2px 2px 4px #000000; padding: 12px 50px 0 100px;">Edit Product</h2>
                            ...
                            <div class="widget-main">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="text" name="name" value="{{$product->name}}" id="name" placeholder="Product Name" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" class="chosen-select form-control" id="categori_id" data-placeholder="Choose a Category...">
                                                    <option value=""></option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="form-field-select-1">SubCategory:</label>
                                                <select name="subcategory_id" class="chosen-select form-control" id="categori_id" data-placeholder="Choose a subCategory...">
                                                    <option value=""></option>
                                                    @foreach ($subcategories as $subcategori)
                                                    <option value="{{$subcategori->id}}" {{ ($subcategori->id == $product->subcategory_id?'selected':'') }}>{{$subcategori->name}}</option> 
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="form-field-select-3">Brand:</label>
                                                <select name="brand_id" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose a Brand...">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="number" name="price" id="price" value="{{$product->price}}" placeholder="&#2547; Price" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="number" value="{{$product->discount}}" name="discount" id="discount" placeholder="&#2547; Discount %" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="green col-sm-3 control-label no-padding-right" for="form-field-1">Short Description:</label>
                                            <div class="col-sm-9">
                                                <!-- Short Description content here -->
                                                <div class="widget-box">
                                                    <div class="widget-body">
                                                        <div class="widget-main no-padding">
                                                            <textarea name="short_desp" id="summernote" cols="30" rows="10">{!!$product->short_desp!!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="widget-box">
                                                    <div class="widget-body">
                                                        <div class="widget-main no-padding">
                                                           <textarea name="long_desp" id="summernote1" cols="30" rows="10">{!!$product->long_desp!!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <label class="middle">
                                                <img height="145" id="blah" width="155" src="{{ asset('images/products/preview/' . $product->preview) }}" alt="Image">
                                            </label>
                                        </span>
                                    </div>
                                </div>
