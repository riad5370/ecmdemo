                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory_id" class="form-control js-example-basic-single" id="subcategory">
                                                ...
                                                <div class="widget-box">
                                                    <div class="widget-body">
                                                        <div class="widget-main no-padding">
                                                            <textarea name="short_desp" id="summernote" cols="30" rows="10">{{old('short_desp')}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
