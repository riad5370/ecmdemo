                ...
                <tbody>
                    ...
                    @foreach ($products as $product)
                        <tr role="row" class="{{ $loop->odd ? 'odd' : 'even' }}">
                            ...
                            <td class="center">{{ $product->subcategory->name ?: 'Unknown SubCategory' }}</td>
                            <td class="center">{{ $product->brand->name ?: 'Unknown Brand' }}</td>
                            ...
                            <td class="center">
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="{{route('products.inventory',$product->id)}}">
