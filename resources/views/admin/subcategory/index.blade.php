...
<div style="background-color: #3498DB; width:100%;height:190px;">
    <h2 style="margin: 0; color: white; text-shadow: 2px 2px 4px #000000; padding: 12px 50px 0 100px;">SubCategory Information</h2>
    <h6 style="margin-top: 2px; padding: 0 50px 0 100px;">
        ...
        <?php
        $categoryCount = $subcategories->count();    
       ?>
    <div class="">
        <div class="col-xs-8" style="margin-top: 0;">
            ...
            <div class="table-header">All Sub Category ({{$categoryCount}})</div>
            <div>
                        ...
                        <tr role="row" class="">
                            ...
                            <td class="center">
                                @if ($subcategory->image)
                                    <img width="50px" src="{{ asset('images/SubCategory/' . $subcategory->image) }}" alt="">
                                @else
                                    <span>null</span>
                                @endif
                            </td>
        ...
        <div class="col-xs-4 col-md-4 col-sm-4" style="margin-top: 0;">
            ...
            <div class="widget-box" style="margin-top: 0; padding-top:0;">
                <div class="widget-header">
                    <h4 class="widget-title">Add Subcategory</h4>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Category<span style="color: #B74635; font-weight:bold;">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">SubCategory Name<span style="color: #B74635; font-weight:bold;">*</span>:</label>
